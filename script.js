            ...
            .then(data => {
                ...
                var pcIndex = e.target.dataset.pcindex
                 if(document.getElementsByClassName("page-body")[0]) {//サンプル表示変更
                   ...
                   if(!document.getElementsByClassName("icon")[0].style.background) document.getElementsByClassName("icon")[0].style.background = `url(imge/${PcListDate[pcIndex].img}) 0% 0% / cover no-repeat`
